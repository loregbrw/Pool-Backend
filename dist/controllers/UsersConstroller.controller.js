...
const UserService_service_1 = __importDefault(require("../services/UserService.service"));
const errors_1 = __importDefault(require("../errors"));
class UsersController {
}
_a = UsersController;
UsersController.login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const token = yield AuthService_service_1.default.login(req.body);
    return res.status(200).json({ token });
});
UsersController.create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield UserService_service_1.default.create(req.body);
...
UsersController.get = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield UserService_service_1.default.getById(userSession.id);
...
UsersController.update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!userSession)
        throw new errors_1.default("Unathorized!", 401);
    const user = yield UserService_service_1.default.update(userSession.id, req.body);
    return res.status(200).json({ user });
});
UsersController.delete = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!userSession)
        throw new errors_1.default("Unathorized!", 401);
    yield UserService_service_1.default.delete(userSession.id);
    return res.status(204).send();
});
UsersController.getPagination = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    // require token to get users!
    const { page = 1, size = 10, search = "" } = req.query;
    const users = yield UserService_service_1.default.getPagination(Number(page), Number(size), search);

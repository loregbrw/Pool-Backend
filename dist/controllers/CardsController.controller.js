...
const CardService_service_1 = __importDefault(require("../services/CardService.service"));
...
CardsController.create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const card = yield CardService_service_1.default.create(req.body);
...
CardsController.update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!userSession)
        throw new errors_1.default("Unathorized!", 401);
    // verify if there is access
    const card = yield CardService_service_1.default.update(req.params.id, req.body, userSession.id);
    return res.status(201).json({ card });
});
CardsController.getById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!userSession)
        throw new errors_1.default("Unathorized!", 401);
    // verify if there is access
    const card = yield CardService_service_1.default.getById(req.params.id);
    return res.status(201).json({ card });
});
CardsController.getBySprintId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!userSession)
        throw new errors_1.default("Unathorized!", 401);
    // verify if there is access
    const cards = yield CardService_service_1.default.getBySprintId(req.params.sprintId);
